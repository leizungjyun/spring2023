...
![alt text](2024-12-09-brain-inspired/chengjiang.jpg) <!-- .element: height="600" --> 
...
![alt text](2024-12-09-brain-inspired/nissl.png)<!-- .element: height="300" --> 
![alt text](2024-12-09-brain-inspired/golgi.png)<!-- .element: height="300" -->
...
![alt text](2024-12-09-brain-inspired/neocortex.png)<!-- .element: height="500" -->
...
![rosenblatt](2024-12-09-brain-inspired/rosenblatt.png)
...
![alt text](2024-12-09-brain-inspired/cannoboid.png)<!-- .element: height="500" -->
...
![ett](2024-12-09-brain-inspired/e-turing-test.png) <!-- .element: height="200" -->
...
==
![alt text](2024-12-09-brain-inspired/neuraltube.png)<!-- .element: height="500" -->
...
![alt text](2024-12-09-brain-inspired/animals.png)<!-- .element: height="250" --> $\quad$ ![alt text](2024-12-09-brain-inspired/levels.png)<!-- .element: height="250" --> 
...
![alt text](2024-12-09-brain-inspired/animals.png)<!-- .element: height="350" -->
...
![alt text](2024-12-09-brain-inspired/levels.png)<!-- .element: height="450" --> 
...
![alt text](2024-12-09-brain-inspired/cells.png)<!-- .element: height="500" -->

The cell

==

![alt text](2024-12-09-brain-inspired/cells-neurons.png)<!-- .element: height="500" -->

The neuron

==
![alt text](2024-12-09-brain-inspired/rest-potential.png)<!-- .element: height="500" -->

Na/K ion pumps

==
![alt text](2024-12-09-brain-inspired/rest-potential2.png)<!-- .element: height="400" -->

Rest potential

==

![alt text](2024-12-09-brain-inspired/action-potential.png)<!-- .element: height="500" -->

Action potential

==
![alt text](2024-12-09-brain-inspired/synapse.png)<!-- .element: height="500" -->

The synapse
==

![alt text](2024-12-09-brain-inspired/EPSP.png)<!-- .element: height="500" -->

EPSP: Excitatory postsynaptic potential

==

![alt text](2024-12-09-brain-inspired/IPSP.png)<!-- .element: height="500" -->

IPSP: Inhibitory postsynaptic potential

==
![alt text](2024-12-09-brain-inspired/synaptic-integration.png)<!-- .element: height="400" -->

The linear part: Synaptic integration

==

![alt text](2024-12-09-brain-inspired/g-protein-modulation.png)<!-- .element: height="400" -->
...
![alt text](2024-12-09-brain-inspired/crossbar.png) <!-- .element: height="450" --> 

The Epsilon Neural Network on a crossbar

==

![alt text](2024-12-09-brain-inspired/VBN.png) <!-- .element: height="450" --> 
...
![alt text](2024-12-09-brain-inspired/event-camera.jpeg) <!-- .element: height="450" --> 

Event-based camera

==

![alt text](2024-12-09-brain-inspired/yu-etal.png) <!-- .element: height="450" --> 
...
![alt text](2024-12-09-brain-inspired/insect-behavior.png) <!-- .element: height="450" --> 
...
==
![frame-of-mind](2024-12-09-brain-inspired/rotation.png)<!-- .element: height="500" --> 

Whether the second form is a rotation of the first

==

![alt text](2024-12-09-brain-inspired/stairs.png) <!-- .element: height="500" --> 

Upstairs or downstairs?

==

![alt text](2024-12-09-brain-inspired/binocular.png) <!-- .element: height="500" --> 
...
![Alt text](2024-12-09-brain-inspired/hippocampus.png)<!-- .element: height="500" --> 
