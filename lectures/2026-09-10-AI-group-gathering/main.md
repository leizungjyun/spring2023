...
Papers · Engineering · Funding · Milestones
...
<div class="paper-status">Accepted papers</div>
...
<img class="paper-teaser" src="images/宇航学报-teaser.png" alt="类脑空间智能导航 paper overview">
...
<img class="paper-teaser" src="images/INMMiC-teaser.png" alt="Tunnel Diode-Based paper overview">

===

<!-- .slide: class="paper-slide" -->
<div class="paper-status">Rebuttal</div>
...
<img class="paper-teaser" src="images/KANalogue-teaser.png" alt="KANalogue paper overview">
...
<img class="paper-teaser" src="images/spin_uv-teaser.png" alt="SPIN-UV paper overview">

===

<!-- .slide: class="paper-slide" -->
<div class="paper-status">Submitted papers</div>
...
<img class="paper-teaser" src="images/kelvin-teaser.png" alt="KELVIN paper overview">
...
<img class="paper-teaser" src="images/Calliphase-teaser.jpg" alt="CalliPhase paper overview">
...
<div class="formula"><i>X</i><sub>n</sub> ∼ Binomial(<i>n</i>, <i>p</i>) &nbsp;&nbsp; ⇒ &nbsp;&nbsp; P(<i>X</i><sub>n</sub> ≥ 1) = 1 − (1 − <i>p</i>)<sup><i>n</i></sup></div>
...
<img class="demo-image" src="images/cyclex-engin-result.png" alt="CycleX: Cross-platform demonstration">
...
<img class="demo-image" src="images/calli-engin-result.png" alt="Results showcase">
...
<div class="smartrat-grid">
<figure><img src="images/smartrat-teaser1.png" alt="Smart rat core board front rendering"><figcaption>Front</figcaption></figure>
<figure><img src="images/smartrat-teaser2.png" alt="Smart rat core board rear rendering"><figcaption>Rear</figcaption></figure>
<figure><img src="images/smartrat-teaser3.png" alt="Smart rat front board layout"><figcaption>Front layout</figcaption></figure>
<figure><img src="images/smartrat-teaser4.png" alt="Smart rat rear board layout"><figcaption>Rear layout</figcaption></figure>
</div>
...
<div class="funding">RMB 5.80 million</div>
...
<p class="ra-role">Research assistant</p>
<img src="images/shihang.jpg" alt="Portrait of 史航">
<h1>史航</h1>
</div>
...
<img class="campus-photo" src="images/suat-swimming-pool.jpg" alt="Swimming pool on the SUAT campus">
...
<p class="research-intro">Research ideas to explore</p>
<div class="two-columns">
<div><h3>Self-balancing <span class="research-level">L0–L2</span></h3><ul><li>Stationary balance</li><li>High-speed operation</li><li>Generalization</li><li>Robustness</li></ul></div>
<div><h3>Autonomous navigation <span class="research-level">L3</span></h3><ul><li>Localization and mapping</li><li>Global route planning</li><li>Local obstacle avoidance</li><li>Visual goal navigation</li></ul></div>
</div>
...
<p class="research-intro">Research ideas to explore</p>
<div class="two-columns">
<div><h3>Computing hardware</h3><ul><li>Scaling up using SiP</li><li>CNN-like AIMC</li></ul></div>
<div><h3>Applications</h3><ul><li>High-speed autofocus</li><li>Commercialization</li></ul></div>
</div>
...
<div class="two-columns">
<div><h3>Group lessons</h3><p>For beginner students</p></div>
<div><h3>Team workshops</h3><p>For each research direction</p></div>
</div>
...
<img class="ending-image" src="images/ending.jpg" alt="Raised hands and colorful question marks">
