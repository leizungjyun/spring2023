...
![alt text](stairs.png) <!-- .element: height="500" --> 
...
#### The Difference from Embodied Intelligence?
...
*It it only proper to realize that language is largely a historical accident.*  <!-- .element: style="float: left; width: 50%; padding-right:1em; text-align: justify;" -->


![vonneumann](https://i.guim.co.uk/img/static/sys-images/Observer/Pix/pictures/2012/2/23/1330005410449/John-von-Neumann-and-the--007.jpg?width=465&dpr=1&s=none&crop=none)<!-- .element: style="width: 35%" -->
