...
![alt text](images/xzy.png) <!-- .element: width="350" -->

![alt text](images/lzw.png) <!-- .element: width="350" -->
...
<img class="r-stretch" src="images/KAN-arxiv.png">
...
==
<img class="r-stretch" src="images/ziming.png">
Liu Ziming (刘子鸣) presents KANs on Swarma Pattern
==


![alt text](images/wechat.png) <!-- .element: width="450" -->

![alt text](images/datawhale.png) <!-- .element: width="450" -->

Swarma Pattern's most popular live stream in history

==

<img class="r-stretch" src="images/ziming-songyuan.png">
...
![alt text](images/shallow-mlp.png)

How many learnable weights?

==
![alt text](images/gpt4.png)<!-- .element: width="550" -->

GPT-4
==
![alt text](images/gpt-4o.png)<!-- .element: width="500" -->
...
<img class="r-stretch" src="images/kart-to-kan.png">


$$\Phi = \(\phi_{q,p}\), \quad p = 1, 2, \dots, n_{\text{in}}, \quad q = 1, 2, \dots, n_{\text{out}}$$

==
<img class="r-stretch" src="images/deepkan.png">
$$\text{KAN}(\mathbf{x}) = (\Phi_3 \circ \Phi_2 \circ \Phi_1)(\mathbf{x})$$
==
<img class="r-stretch" src="images/mlp-kan.png">

===
![alt text](images/b-splines.png)
...
==
#### Faster scaling
![alt text](images/symbolic-formulas.png)
Fitting symbolic formulas
==

#### Interpretable
![alt text](images/interpretable.png)
==
...
![alt text](images/reductionism-holism.png)

==

![alt text](images/controversial-opinion.png)
